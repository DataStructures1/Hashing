...
public class HashObject {
   ...
   private int hashChooser(int oldHashValue) {
	  ...
	  case 3: {
		 return customRehasher(oldHashValue);
	  }
	  }
	  return -1;
   }
   ...
   private void nameStrategy() {
	  switch (hashmethod) {
	  case 0: {
		 System.out.println("using adjacency."); break;
	  }
	  case 1: {
		 System.out.println("using linear."); break;
	  }
	  case 2: {
		 System.out.println("using quadratic."); break;
	  }
	  case 3: {
		 System.out.println("using custom."); break;
	  }
	  }
   }
